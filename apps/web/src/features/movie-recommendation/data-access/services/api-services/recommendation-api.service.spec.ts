...
describe('recommendation API', () => {
  ...
  describe('when creating a session', () => {
    it('sends the cookie, CSRF token, and selected profile', async () => {
  ...
  describe('when querying the catalog', () => {
    it('returns the received movies using the selected filters', async () => {
      vi.stubGlobal('fetch', mockHttp({
    ...
    it('returns the API error when the catalog request fails', async () => {
      vi.stubGlobal('fetch', mockHttp({
